...
topLight.position.set(500, 1000, 750) //top-left-ish
topLight.castShadow = true;
scene.add(topLight);

const topLight2 = new THREE.DirectionalLight(0x404040, 2); // (color, intensity)
topLight2.position.set(2000, 1000, -2000) //top-left-ish
